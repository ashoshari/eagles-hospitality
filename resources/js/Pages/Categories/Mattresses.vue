...
<template>
    <Head :title="locale == 'en'? 'Mattresses' : 'المفارش'" />
        ...
        <section class="container-fluid py-5">
            ...
            <section class="row g-4">
                ...
                >
                    ...
                    >
                        <img width="400" height="350" loading="lazy"
                        :src="product.imageUrl" :alt="locale == 'en'? 'Product image' : 'صورة المنتج'" class="shopImg" />
                    </Link>
